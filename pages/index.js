export default function IndexPage() {
  return (
    <div>
      <h1 className="text-5xl text-center text-gray-700">Niru Maheswaranathan</h1>
      <h4 className="md:text-2xl">Machine learning and neuroscience research</h4>
      ...
      {/* </div> */}
      <article className="py-2 prose md:py-4">
        <h2>About Me</h2>
