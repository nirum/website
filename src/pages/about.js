...
export default () => (
  <Layout>
    ...
    <p className='mt-4'>Previously, I completed my PhD in neuroscience in the labs of Surya Ganguli and Steve Baccus at Stanford University, where I studied neural circuits in the retina. My research focused on brining together computational models and data from electrophysiological experiments to better understand how we process visual information.</p>
