...
export default ({data}) => {
  ...
  <Layout>
    <div className="flex flex-col items-center">
      ...
      <h2 className="font-serif text-sm italic tracking-tight text-md sm:text-lg md:text-2xl text-foreground">Machine learning and neuroscience research</h2>
    </div>
    ...
    <div className="pt-16 font-serif md:pt-24 text-foreground">
      <h2 className="font-sans text-2xl font-semibold tracking-tight text-foreground-primary">About Me</h2>
