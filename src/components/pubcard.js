...
export default ({ pub }) => (
  <div className="border-warm-grey-400 border-t-2 pt-4 mt-8">
      ...
      <p className="font-sans leading-tight mt-2 text-xl tightbold text-warm-grey-700">{pub.title}</p>
      <p className="font-sans leading-snug text-warm-grey-500 mt-2">{pub.authors.join(", ")}</p>
