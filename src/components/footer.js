    ...
    <footer className="inset-x-0 bottom-0 flex justify-around py-4 pb-8 mt-32 bg-gray-900 border-t border-gray-100 min-h-32">
        <div className="grid gap-8 mt-8 mb-8 ml-16 text-gray-500 md:gap-4 responsive-width sm:ml-0 sm:grid-cols-2 md:grid-cols-3">
            ...
            <div className="flex flex-col justify-start">
                ...
                <div className="font-sans leading-6 text-gray-400">Made with <a className={link} href="https://tailwindcss.com" target="_blank" rel="noopener noreferrer">Tailwind&thinsp;CSS</a> &amp; <a className={link} href="https://www.gatsbyjs.org" target="_blnak">Gatsby&thinsp;JS</a>.</div>
