...
export default () => (
    <footer className="bg-gray-900 min-h-32 mt-32 py-4 pb-8 inset-x-0 bottom-0 flex justify-around dark-mode:border-t-2 dark-mode:border-gray-700">
        <div className="responsive-width">
            <div className="py-8 flex flex-col md:px-0 md:flex-row justify-between items-start font-sans font-light text-sm text-gray-400">
                <div className="flex flex-col justify-start">
                    <p className="text-gray-100 font-semibold font-sans">Sitemap</p>
                ...
                <div className="flex flex-col justify-start">
                    <p className="mt-8 md:mt-0 text-gray-100 font-semibold font-sans">Elsewhere</p>
                    <ul className="md:mt-2 leading-6">
                        <li>
                ...
                <div className="flex flex-col justify-start">
                    <p className="mt-8 md:mt-0 text-gray-100 font-semibold font-sans">&copy; 2015-2020</p>
                    <p className="md:mt-2 leading-6 text-gray-400 font-sans">Made with <a className="footer-link" href="https://tailwindcss.com" target="_blank" rel="noopener noreferrer">Tailwind&thinsp;CSS</a> &amp; <a className="footer-link" href="https://www.gatsbyjs.org" target="_blnak">Gatsby&thinsp;JS</a>.</p>
                </div>
                <div className="mt-4 pb-4 md:mt-0 w-8 text-brand-lighter">
