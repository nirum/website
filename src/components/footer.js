...
export default () => (
    <footer className="inset-x-0 bottom-0 flex justify-around py-4 pb-8 mt-32 bg-gray-900 min-h-32 dark-mode:border-t-2 dark-mode:border-gray-700">
        <div className="grid gap-8 mt-8 mb-8 ml-16 text-gray-400 md:gap-4 responsive-width sm:ml-0 sm:grid-cols-2 md:grid-cols-3">
            <div className="flex flex-col justify-start">
                <p className="font-sans font-semibold text-gray-100">Sitemap</p>
                <ul className="leading-6">
                    ...
                    <li><Link className="footer-link" to="/code">Code</Link></li>
                    {/* <li><Link className="footer-link" to="/blog">Blog</Link></li> */}
                </ul>
            </div>
            <div className="flex flex-col justify-start">
                <p className="font-sans font-semibold text-gray-100">Elsewhere</p>
                <ul className="leading-6">
                    <li>
                        <a className="footer-link" href="https://twitter.com/niru_m/">
                            <Icon name="twitter" className="w-3 h-3 mr-2 -ml-5" />@&#8202;niru_m
                        </a>
                    </li>
                    <li>
                        <a className="footer-link" href="https://scholar.google.com/citations?user=bEOT7ScAAAAJ">
                            <Icon name="scholar" className="w-3 h-3 mr-2 -ml-5" />Google Scholar
                        </a>
                    </li>
                    <li>
                        <a className="footer-link" href="https://www.github.com/nirum/">
                            <Icon name="github" className="w-3 h-3 mr-2 -ml-5" />github.com/nirum
                        </a>
                    </li>
                    <li>
                        <a className="footer-link" href="https://pinboard.in/u:nirum/">
                            <Icon name="pinboard" className="w-3 h-3 mr-2 -ml-5" />pinboard.com/u:nirum
                        </a>
                    </li>
                </ul>
            </div>
            <div className="flex flex-col justify-start">
                <p className="font-sans font-semibold text-gray-100">&copy; 2015-2020</p>
                <p className="font-sans leading-6 text-gray-400">Made with <a className="footer-link" href="https://tailwindcss.com" target="_blank" rel="noopener noreferrer">Tailwind&thinsp;CSS</a> &amp; <a className="footer-link" href="https://www.gatsbyjs.org" target="_blnak">Gatsby&thinsp;JS</a>.</p>
                <div className="w-8 mt-4 text-brand-lighter">
